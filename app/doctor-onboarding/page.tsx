        ...
        <Grid justify="center" align="center" gutter={"lg"}>
            ...
            <Group my={"lg"}>
                  ...
                  <Flex wrap={"wrap"} gap={"md"}>
                    <Button size="md" bg={"#1C7ED6"} className="hover:bg-[#104e85]"><Link href={"tel:+918750300099"}>Contact Us: +918750300099</Link> </Button>
            ...
            <Grid.Col span={{base:12,md:6}}>
                <Card p={"md"} shadow="md" my={"lg"}>
                    <Card.Section p={"lg"}>
                <Text fw={600} size="lg">Doctor Details</Text>
              <Text c="dimmed" fz={14}>
              Please share your details, and we&apos;ll get back to you with the next steps!
              </Text>
                    </Card.Section>
                    <Card.Section p={"lg"}>
                    <DoctorOnboardingForm></DoctorOnboardingForm>
                    </Card.Section>
                </Card>
        </Grid.Col>  
        <Grid.Col>
