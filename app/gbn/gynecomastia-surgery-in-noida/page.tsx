  ...
  ">
    ...
    <button className="w-full bg-[#14967F] text-white font-bold py-3 rounded-full text-[16px] shadow hover:opacity-90 transition">
      ...
      <section className="w-full bg-[#14967F] py-2.5 mt-2 border-t border-white/20">
        ...
        ">
          <div className="px-1">
            <h3 className="text-white text-[14px] md:text-[20px] font-extrabold leading-none">45K+</h3>
            <p className="text-white text-[8px] md:text-xs font-bold uppercase mt-0.5 leading-tight">Satisfied<br/>Patients</p>
          </div>
          <div className="px-1">
            <h3 className="text-white text-[14px] md:text-[20px] font-extrabold leading-none">300+</h3>
            <p className="text-white text-[8px] md:text-xs font-bold uppercase mt-0.5 leading-tight">Specialist<br/>Doctors</p>
          </div>
          <div className="px-1">
            <h3 className="text-white text-[14px] md:text-[20px] font-extrabold leading-none">500+</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
          ...
          <div className="bg-[#E9F1FF] rounded-2xl p-6 lg:p-8">
            ...
            <ul className="space-y-3">
              {[
                "Workout, exercise, diet won't help",
                "Medication, fat burner pills won't work",
                "Homeopathy, Ayurveda is ineffective",
          ...
          <div className="bg-[#E9F1FF] rounded-2xl p-6 lg:p-8">
            ...
            <ul className="space-y-3">
              {[
                "Barely Visible Scars • No Recurrence",
          ...
          <div className="bg-[#E9F1FF] rounded-2xl p-6 lg:p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Private Room",
                "Free follow ups Post Treatment"
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="text-[#14967F] font-bold text-lg leading-none mt-0.5">✓</span>
                  <span className="text-gray-800 text-[14px] lg:text-[16px] font-medium leading-tight">
     ...
     <section className="w-full py-10 lg:py-14 bg-white">
        ...
        <div className="max-w-[1200px] mx-auto bg-[#F1F3F8] rounded-xl overflow-hidden border border-[#E5E7EB]">
          ...
          {[
            ...
            ["Blood Loss", "HEAVY", "NO BLOOD LOSS"],
